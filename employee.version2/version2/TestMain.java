...
public class TestMain {
    public static void main(String[] args) {
        HourlyEmployee emp = new HourlyEmployee(1, "Joe" , new myDate(23,2,2023), new myDate(3,3,2001), 45.20F, 100.20F);
        emp.displayInfo();
        ...
        PieceWorkerEmployee emp6 = new PieceWorkerEmployee (6, "Mello" , new myDate(6,6,2020), new myDate(19,11,2000), 40.00F, 100.2F);
        emp6.displayInfo();

        ComissionEmployee emp7 = new ComissionEmployee (7, "Keong" , new myDate(7,7,2007), new myDate(8,8,1998), 40000.00);
        emp7.displayInfo();
        ...
        BasePlusComissionEmployee emp10 = new BasePlusComissionEmployee (5, "Juan" , new myDate(6,6,2020), new myDate(19,11,2000), 40.5, 100.2);
        emp10.displayInfo();

        BasePlusComissionEmployee emp11 = new BasePlusComissionEmployee (6, 40.5, 100.2);
        emp11.setempName("Sui");
